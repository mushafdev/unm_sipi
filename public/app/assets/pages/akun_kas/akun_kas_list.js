...
table = $('#table').DataTable({
    ...
    {data: 'nomor_akun', name: 'nomor_akun'},
...
$(document).on( 'click', '.edit', function () {
    ...
    success : function(data) {
        $('#id').val(data.id);
        $('#param').val('edit');
        $("#nama_akun").val(data.result.nama_akun);
        $("#nomor_akun").val(data.result.nomor_akun);
        $("#nomor_rekening").val(data.result.nomor_rekening);
        $('.modal-load').hide();
    }
    });
