...
table = $('#table').DataTable({
    ...
    columns: [
        ...
        { data: 'total_system', name: 'total_system', className: 'text-end' },
        { data: 'total_aktual', name: 'total_aktual', className: 'text-end' },
        { data: 'selisih', name: 'selisih', className: 'text-end' },
