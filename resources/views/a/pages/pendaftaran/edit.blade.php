...
<div class="page-content"> 
    ...
    <section class="section">
        <form name="form" id="form" data-update="{{route('pendaftaran.update',encrypt0($data->id))}}" data-index="{{route('pendaftaran.index')}}" data-detail-pasien="{{route('pasien.detail_data')}}" method="POST">
        @method('PUT')
        {{ csrf_field() }}
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-3 text-end">
                                ...
                                <a href="{{route('pendaftaran.create')}}" class="btn icon icon-left btn-success"><i class="bi bi-plus-circle"></i> Tambah</a>
                                @endcan
