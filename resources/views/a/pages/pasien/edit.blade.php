...
<div class="page-content"> 
    <section class="section">
        <form name="form" id="form" data-update="{{route('pasien.update',encrypt0($data->id))}}" data-index="{{route('pasien.index')}}" enctype="multipart/form-data" method="POST">
        @method('PUT')
        {{ csrf_field() }}
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_rm" id="no_rm" class="form-control bg-light-warning text-danger" placeholder="No. RM" value="{{$data->no_rm}}" readonly>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="panggilan" id="panggilan" class="form-control" placeholder="Nama Panggilan" value="{{$data->panggilan}}" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="gelar_depan" class="form-label">Gelar Depan</label>
                                        <input type="text" name="gelar_depan" id="gelar_depan" class="form-control" placeholder="Gelar Depan" value="{{$data->gelar_depan}}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="gelar_belakang" class="form-label">Gelar Belakang</label>
                                        <input type="text" name="gelar_belakang" id="gelar_belakang" class="form-control" placeholder="Gelar Belakang" value="{{$data->gelar_belakang}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex mt-2">
                                            @foreach ($display_namas as $dt )
                                                <div class="form-check me-3">
                                                    <input class="form-check-input" type="radio" name="display_nama" id="display_{{$dt->value}}" value="{{$dt->value}}" {{$dt->value==$data->display_nama?'checked':''}}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control" placeholder="" value="{{$data->tgl_lahir}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="jenis_kelamin" id="jenis_kelamin" class="form-control" required>
                                            ...
                                            <option value="{{$dt->value}}" {{$dt->value==$data->jenis_kelamin?'selected':''}}>{{$dt->label()}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="agama_id" id="agama_id" class="form-control select2" required data-parsley-errors-container="#agama-errors">
                                            ...
                                            @foreach ($agamas as $dt )
                                                <option value="{{$dt->id}}" {{$dt->id==$data->agama_id?'selected':''}}>{{$dt->agama}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status_kawin" id="status_kawin" class="form-control">
                                            ...
                                            @foreach ($status_kawins as $dt )
                                                <option value="{{$dt->value}}" {{$dt->value==$data->status_kawin?'selected':''}}>{{$dt->label()}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="golongan_darah" id="golongan_darah" class="form-control">
                                            ...
                                            @foreach ($golongan_darahs as $dt )
                                                <option value="{{$dt->value}}" {{$dt->value==$data->golongan_darah?'selected':''}}>{{$dt->label()}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="pendidikan_id" id="pendidikan_id" class="form-control select2" data-parsley-errors-container="#pendidikan-errors" >
                                            ...
                                            @foreach ($pendidikans as $dt )
                                                <option value="{{$dt->id}}" {{$dt->id==$data->pendidikan_id?'selected':''}}>{{$dt->pendidikan}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="pekerjaan_id" id="pekerjaan_id" class="form-control select2" data-parsley-errors-container="#pekerjaan-errors">
                                            ...
                                            @foreach ($pekerjaans as $dt )
                                                <option value="{{$dt->id}}" {{$dt->id==$data->pekerjaan_id?'selected':''}}>{{$dt->pekerjaan}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_hp" id="no_hp" class="form-control" placeholder="085xxxxxxxxx" value="{{$data->no_hp}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="prov_id" id="prov_id" class="form-control select2-prov" data-parsley-errors-container="#prov-errors">
                                            <option value="{{$data->prov_id}}">{{$data->provinsi}}</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="kab_id" id="kab_id" class="form-control select2-kab" data-parsley-errors-container="#kab-errors">
                                            <option value="{{$data->kab_id}}">{{$data->kabupaten}}</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="kec_id" id="kec_id" class="form-control select2-kec" data-parsley-errors-container="#kec-errors">
                                            <option value="{{$data->kec_id}}">{{$data->kecamatan}}</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="kel_id" id="kel_id" class="form-control select2-kel" data-parsley-errors-container="#kel-errors">
                                            <option value="{{$data->kel_id}}">{{$data->kelurahan}}</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode_pos" id="kode_pos" placeholder="Kode Pos" class="form-control" value="{{$data->kode_pos}}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="tags[]" id="tags" class="form-control select2-tag" multiple data-parsley-errors-container="#tag-errors">
                                            @foreach ($tags as $dt )
                                                <option value="{{$dt->tag}}" selected>{{$dt->tag}}</option>
                                            @endforeach
                                        </select>
