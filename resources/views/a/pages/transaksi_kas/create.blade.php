...
<div class="page-content"> 
    <section class="section">
        <form name="form" id="form" data-store="{{route('transaksi-kas.store')}}" data-index="{{route('transaksi-kas.index')}}" method="POST">
        {{ csrf_field() }}
...
<script src="{{asset('app/assets/pages/keuangan/transaksi_kas.js')}}?v={{identity()['assets_version']}}"></script>
@endsection