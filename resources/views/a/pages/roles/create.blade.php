...
<div class="page-content"> 
    <section class="section">
        <form name="form" id="form" data-store="{{route('roles.store')}}" data-index="{{route('roles.index')}}" method="POST">
        {{ csrf_field() }}
        <div class="row">
                                        ...
                                        @foreach($permissions as $key => $group)
                                            <tr class="">
                                                ...
                                                <td class="">
                                                    ...
                                                    <label class="">
                                                        <input name="permissions[]" class="permissioncheckbox form-check-input" type="checkbox" value="{{ $permission->id }}">
                                                        @php
