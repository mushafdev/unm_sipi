        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table" id="table" data-list="{{route('satuan.get_satuan')}}" data-url="{{route('satuan.index')}}">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Satuan</th>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <input id="satuan" name="satuan" type="text" placeholder="Satuan" class="form-control" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="{{asset('app/assets/pages/satuan/satuan_list.js')}}"></script>
@endsection