        ...
        <div class="card mb-3">
            <div class="card-header d-flex justify-content-between align-item-center">
                ...
                @if (!in_array($pendaftaran->status, ['Pembayaran', 'Selesai']))
                    <button class="btn btn-success" type="button" id="add-item"><i class="bi bi-plus-circle me-1"></i>Tambah</button>
                @endif
            </div>
            <div class="card-body" id="item-list" data-url="{{route('perawatan.item.data',$id)}}">
...
<div class="modal fade text-left" id="modalItem" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-md"
        ...
        <div class="modal-content">
            ...
            <form  id="form-item" name="form-item" data-index="{{route('perawatan.index')}}" data-store="{{route('perawatan.item.store')}}" data-id="{{$id}}">
                {{csrf_field()}}
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="item">Produk<span class="text-danger ms-0">*</span> </label>
                            <div class="form-group">
                                <select class="form-select select2-item" id="item_id" name="item_id">
                                </select>
                            </div>
                        </div>
                        <div class="col-md-5">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="save-item" class="btn icon icon-left btn-primary"><i class="bi bi-save"></i> Simpan</button>
                </div>
            </form>
        </div>
    </div>
</div>
<script src="{{asset('app/assets/pages/perawatan/tab/item.js')}}?v={{identity()['assets_version']}}"></script>
