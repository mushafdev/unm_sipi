        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table" id="table" data-list="{{route('gudang.get_gudang')}}" data-url="{{route('gudang.index')}}">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Gudang</th>
...
<div class="modal fade text-left" id="modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm"
        ...
        <div class="modal-content">
            ...
            <form  id="form" name="form" data-index="{{route('gudang.index')}}" data-get-data="{{route('gudang.get_data')}}">
                {{csrf_field()}}
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="gudang">Gudang<span class="text-danger ms-0">*</span> </label>
                            <div class="form-group">
                                <input id="gudang" name="gudang" type="text" placeholder="Gudang" class="form-control" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="{{asset('app/assets/pages/gudang/gudang_list.js')}}"></script>
@endsection