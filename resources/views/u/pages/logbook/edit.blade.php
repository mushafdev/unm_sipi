...
<div class="page-content"> 
    ...
    <form name="form" id="form" data-update="{{route('logbook.update',encrypt0($data->id))}}" data-index="{{route('logbook.index')}}" enctype="multipart/form-data" method="POST">
    @method('PUT')
    {{ csrf_field() }}
        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="tanggal" id="tanggal" class="form-control" placeholder="Nama" value="{{$data->tanggal}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="jam" class="form-label">Jam<span class="text-danger ms-0">*</span></label>
                                                <input type="time" name="jam" id="jam" class="form-control" placeholder="Nama" value="{{$data->jam}}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea  name="kegiatan" id="kegiatan" class="form-control" rows="10" cols="50" placeholder="Kegiatan" required>{{$data->kegiatan}}</textarea>
                                            </div>
                                        </div>
                                    </div>
