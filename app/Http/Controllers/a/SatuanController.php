...
class SatuanController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:satuan-list', only : ['index','get_satuan','get_data']),
            new Middleware('permission:satuan-create', only : ['store']),
            new Middleware('permission:satuan-edit', only : ['store']),
            new Middleware('permission:satuan-delete', only : ['destroy']),
        ];
    }
    /**
    ...
    {
        $d['title']='Satuan';
        return view('a.pages.satuan.index',$d);
    }
    ...
    {
        $d['title']='Tambah Satuan';
        return view('a.pages.satuan.create',$d);
    }
